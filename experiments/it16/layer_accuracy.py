...
class ViTCLSLayer(nn.Sequential):
    def __init__(self, vit: AugmentedModel, layer: int):
        super().__init__(ViTPre(vit), ViTTransformer(vit, slice(0, layer)), ViTFeatSelector(slice(0, 1)),
                         ViTTransformer(vit, slice(layer, None)), ViTHead(vit, slice(0, 1)))
